...
* Despite rapid improvements in high throuput sequencing technologies, the functional signficance of much of the human genome remains unclear.
...
* A key goal of the project is to more fully decribe the mechanisms of gene transcription. 
...
* They analyzed TF facrtor binding data for 286 CHIP-seq experiments of 67 transcriptional regulators, using Kmer SVM, and three motif finding approaches: MDScan, cERMIT, WeederK1. 
    + Key feature of the Kmer SVM: string kernel developed by the authors specifically for these types of sequence data. 
    
    
* Ultimately, they found the Kmer SVM approach more accurately predicted TF binding than the motif finding approaches, as assesed by area on the curve.  
...
* We dedcided to address a simplified question: Can we use SVM to accurately predict transcription factor binding in a subset of the cell lines and proteins investiagted by Arvey?
...
library("RCurl")
download.file("https://github.com/bradysnifong/Group-6-Final/blob/master/group6.results.RDA?raw=true", "group6.results.RDA")
